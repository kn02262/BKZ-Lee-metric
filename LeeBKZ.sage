...
for s in range(samples):
    ...
    B_profile_lee = ell_profile(B, lee=True)
    print(f"Hamming profile: {B_profile}")
    print(f"Lee profile: {B_profile_lee}")
    ...
    print(f"Hamming profile after BKZ: {B_red_profile}")
    print(f"Lee profile after BKZ: {B_red_profile_lee}")
